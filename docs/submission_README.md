...
| File | Deliverable |
|---|---|
| `π-thon.csv` | 1. Prediction file — 350 rows: Test_ID, Predicted_Reference_Parameter, Validity_Label |
...
validation folds fixed in `folds.csv`. Writes `outputs/final/π-thon.csv`,
